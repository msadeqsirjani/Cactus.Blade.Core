...
public static partial class Extension
{
    ...
    public static DateTimeOffset FromNowOffset(this TimeSpan @this)
    {
    ...
    /// </summary>
    public static DateTimeOffset FromNowOffset(this TimeSpan @this, DateTimeOffset originalValue)
    {
        return originalValue + @this;
    }
}