...
public static partial class Extension
{
    ...
    public static string ToUniversalSortableLongDateTimeString(this System.DateTime @this)
    {
    ...
    /// <returns>The given data converted to a string.</returns>
    public static string ToUniversalSortableLongDateTimeString(this System.DateTime @this, string culture)
    {
