...
public static partial class Extension
{
    ...
    public static string ToFullDateTimeOffsetString(this System.DateTimeOffset @this)
    {
    ...
    /// <returns>The given data converted to a string.</returns>
    public static string ToFullDateTimeOffsetString(this System.DateTimeOffset @this, string culture)
    {
